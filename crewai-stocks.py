...
yahoo_finance_tool = Tool(
  ...
  description = "Fetches stock prices for {ticket} from the last year about a specific company stock from Yahoo Finance API",
...
newsAnalyst = Agent(
  ...
  You're understand news, theirs tittle and information, but you look at those with a health dose of skepticism. 
